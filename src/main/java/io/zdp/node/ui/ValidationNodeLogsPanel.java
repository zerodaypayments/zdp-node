...
public class ValidationNodeLogsPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger(ValidationNodeLogsPanel.class);

	private File file;

	private JTextArea textArea;

	public ValidationNodeLogsPanel() {

		file = new File(SystemUtils.getUserHome(), "/.zdp/logs/validation.log");
