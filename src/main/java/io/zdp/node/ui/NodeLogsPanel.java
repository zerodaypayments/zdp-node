...
public class NodeLogsPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger( NodeLogsPanel.class );

	private File file;

	private JTextArea textArea;

	public NodeLogsPanel ( ) {

		file = new File( SystemUtils.getUserHome(), "/.zdp/logs/node.log" );
