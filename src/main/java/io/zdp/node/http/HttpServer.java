...
public class HttpServer {
	...
	public void init ( ) throws Exception {
		...
		File keyStoreFolder = new File( SystemUtils.getUserHome(), ".zdp" + File.separator + "ssl" + File.separator );
		FileUtils.forceMkdir( keyStoreFolder );

		File keyStoreFile = new File( keyStoreFolder, UUID.randomUUID().toString() + ".ks" );
